...
export function parsePaginationQuery<T,K extends keyof T>(query:Record<string,any>,allowedSortFields: K[],defaultSort: K): PaginationParams<T,K> {
...
export function parseFilters<T, K extends keyof T>(query:Record<string,any> , allowedFields:K[]): FilterParams<T,K>[] {
